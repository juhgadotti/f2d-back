    ...
    public class ProductDataAccess : IProductDataAccess
    {
        public List<ProductDTO> List()
        {
            List<ProductDTO> list = new List<ProductDTO>()
            {
                ...
                new ProductDTO {Id = Guid.Parse("8CFB6326-8E5E-4BFE-B51E-93G1E2E79A6E"), Name = "Pastel", Description = "Queijo, carne, pizza", Category = 2, Price = 10.00, ImageUrl = "images/pastel.jpg"},
